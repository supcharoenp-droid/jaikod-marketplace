        ...
        <section className="py-8">
            <div className="container mx-auto px-4">
                ...
                <div className="flex items-end justify-between mb-6">
                    ...
                    {viewAllLink && (
                        <Link href={viewAllLink} className="hidden md:flex items-center text-sm font-medium text-neon-purple hover:underline">
                ...
                {layout === 'slider' ? (
                    <div className="relative group">
                        ...
                        <div
                            ref={scrollRef}
                            className="flex gap-4 overflow-x-auto pb-4 snap-x snap-mandatory scrollbar-hide px-1 -mx-1"
